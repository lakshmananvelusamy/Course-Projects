...
void Record :: PrintToFile (FILE* file, Schema *mySchema)
{
...
int Record :: GetNumberOfAttributes()
{
    ...
    if(NULL != bits)
    {
        // Gets the position of the 1st attribute offset
        int startOfFirstAttribute = sizeof(int);
        // gets the offset of the 1st attribute..
        // this indicates the end of the last attribute offset
        int endOfLastAttribute = ((int*) bits)[1];
        
        

        numberOfAttributes = (endOfLastAttribute - startOfFirstAttribute) / (sizeof(int));
    }
