...
void q0 (){
	...
	if(result!=800000)
		cout<<"error in estimating Q1 before apply  - " << result << endl;
	else
		cout <<"Q0 is correct. - " << result << endl;
	...
	{
		cout<<"Read or write or last apply is not correct - " << result << endl;
	}
	else
		cout <<"Q0 is correct. " << endl;
...
void q2 (){
	...
	if(fabs(result-1500000) > 0.1)
		cout<<"error in estimating Q2 - " << result << endl;
	else
		cout <<"Q2 is correct. - " << result << endl;
...
Statistics s;
	...
	s.CopyRel("customer","c");
        //cout<<"After copy rel"<<endl;

	char *set1[] ={"s","n1"};
	char *cnf = "(s.s_nationkey = n1.n_nationkey)";
	yy_scan_string(cnf);
	yyparse();
        //cout<<"Before Apply 1"<<endl;
	s.Apply(final, set1, 2);
        //cout<<"After Apply 1"<<endl;

	char *set2[] ={"c","n2"};
	cnf = "(c.c_nationkey = n2.n_nationkey)";
	yy_scan_string(cnf);
	yyparse();
        //cout<<"Before Apply 2"<<endl;
	s.Apply(final, set2, 2);
        //cout<<"After Apply 2"<<endl;
	...
	cout<<"result of the estimate is:"<<result<<"\n";
	if(fabs(result-2400000.0)>0.1)
		cout<<"error in estimating Q3 - " << result << endl;
	else
		cout << "Q3 is correct - " << result << endl;

        //cout<<"Before Apply 3"<<endl;
	s.Apply(final, set3, 4);
        //cout<<"After Apply 3"<<endl;
...
void q4 (){
	...
	if(fabs(result-3200)>0.1)
		cout<<"error in estimating Q4 - " << result << endl;
	else
		cout << "Q4 is correct - " << result << endl;

	s.Apply(final, set, 5);
//	cout<<"result of q4 is :"<<result<<"\n";
...
void q5 (){
	...
	if(fabs(result-400081)>0.1)
		cout<<"error in estimating Q5 - " << result << endl;
	else
		cout <<"Q5 is correct. - " << result << endl;
...
void q6 (){
	...
	if(fabs(result-32000)>0.1)
		cout<<"error in estimating Q6 - " << result << endl;
	else
		cout <<"Q6 is correct. - " << result << endl;
...
void q7(){
	...
	s.AddAtt(relName[1], "l_orderkey",1500000);
        s.AddAtt(relName[1], "l_receiptdate",25000);
	...
	if(fabs(result-2000405)>0.1)
		cout<<"error in estimating Q7 - " << result << endl;
	else
		cout <<"Q7 is correct. - " << result << endl;
...
void q8 (){
	...
	if(fabs(result-47046)>0.1)
		cout<<"error in estimating Q8 - " << result << endl;
	else
		cout <<"Q8 is correct. - " << result << endl;
...
void q9(){
	...
	if(fabs(result-4)>0.5)
		cout<<"error in estimating Q9 - " << result << endl;
	else
		cout <<"Q9 is correct. - " << result << endl;
...
void q10 (){
	...
	if(fabs(result-2000405)>0.1)
		cout<<"error in estimating Q10 - " << result << endl;
	else
		cout <<"Q10 is correct. - " << result << endl;
...
//	cout <<  " result gotten: " << result << endl;
	if(fabs(result-398039)>0.1)
		cout<<"error in estimating Q11...??? - " << result << endl;
		//answer is given as 150040, multiple people have reported differing answers though
	else
		cout << "Q11 is correct - " << result << endl;
	s.Apply(final, relName,2);
//	cout<<"result of q11 is :"<<result<<"\n";
