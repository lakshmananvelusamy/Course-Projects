...
public:
	...
	void Print (Schema *mySchema);
        ...
        // writes the record content to the file
        void PrintToFile(FILE* file, Schema* mySchema);

        // gets the total number of attributes in the record
